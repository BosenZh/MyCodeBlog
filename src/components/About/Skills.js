const SkillList = [
    // Languages
    "Java", "JavaScript", "TypeScript", "C", "C++", "C#", "Golang", "Bash", "Python", "SQL",
    // Technologies
    "Spring Boot", "HTML5", "CSS3", "Gorm", "Node.js", "React", "Vue", "Django", "Pytorch", ".NET",
    // Tools
    "Git", "Linux", "Docker", "Kubernetes", "Jenkins", "OpenXML", "MongoDB", "PostgreSQL", "Postman", "Heroku", "Bootstrap", "Revit"
];
